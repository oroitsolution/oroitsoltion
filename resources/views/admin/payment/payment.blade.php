...
<div class="content-wrapper">
    <div class="row">  
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
        <form method="GET" action="{{ route('superadmin.payment') }}" >
          <div class="card-body">
            <div class="row align-items-end">
             ...
             <div class="col-md-3">
                ...
                <select name="key" class="form-control" id="keySelect">
                  ...
                  <option value="trxid" {{ request('key') == 'trxid' ? 'selected' : '' }}>Trx Id</option>
          ...
          <div class="card-footer">
            <div class="d-flex">
              ...
              <a href="{{url('superadmin/payment')}}" class="btn btn-danger me-2">Date Reset</a>
