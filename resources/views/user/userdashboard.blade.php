...
@section('title', 'User Panel || ORO IT SOLUTION')
@section('content')
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview"
                                role="tab" aria-controls="overview" aria-selected="true">Your Overview</a>
                        </li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <p class="statistics-title">Total Add Money</p>
                                        <h3 class="rate-percentage">70,682</h3>

                                    </div>
                                    <div>
                                        <p class="statistics-title">Total Send Money</p>
                                        <h3 class="rate-percentage">50,682</h3>

                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Total Charges</p>
                                        <h3 class="rate-percentage">3,200</h3>

                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Today Add Money</p>
                                        <h3 class="rate-percentage">680.8</h3>

                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Today Send Money</p>
                                        <h3 class="rate-percentage">5690</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
