    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <img class="img-xs rounded-circle" src="{{ asset('admin/layout/assets/images/favicon.png') }}"
                        alt="Profile image">
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown" aria-labelledby="UserDropdown">
                    ...
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle mb-2" src="{{ asset('admin/layout/assets/images/logo.svg') }}"
                            alt="Profile image" style="width: 90px; height: 60px;">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        My Profile
                        <span class="badge badge-pill badge-danger ms-auto">1</span>
                    </a>
